...
namespace FinalProject.Helpers
{
    public class ConnectDb(DbContextOptions<ConnectDb> options) : DbContext(options)
    {
        ...
        public DbSet<Category> Category { get; set; } //หมวดพนักงาน
        public DbSet<Warehouse> Warehouse { get; set; } //คลังพนักงาน
        public DbSet<Product> Product { get; set; } //พนักงาน
        public DbSet<Inventory> Inventory { get; set; } //พนักงานคงเหลือแต่ละคลัง
        ...
        public DbSet<ReceiveGoods> ReceiveGoods { get; set; } //ใบรับพนักงาน
        public DbSet<ReceiveGoodsDetail> ReceiveGoodsDetail { get; set; }
        public DbSet<Lot> Lot { get; set; } //Lotพนักงาน
        public DbSet<MovementType> MovementType { get; set; } //ประเภทการเคลื่อนไหว
        public DbSet<MovementProduct> MovementProduct { get; set; } //การเคลื่อนไหวของพนักงาน
        public DbSet<DeliveryGoods> DeliveryGoods { get; set; } //ใบส่งพนักงาน
        public DbSet<DeliveryGoodsDetail> DeliveryGoodsDetail { get; set; }
        public DbSet<GoodsReturnFromCustomer> GoodsReturnFromCustomer { get; set; } //รับคืนพนักงาน
        public DbSet<GoodsReturnFromCustomerDetail> GoodsReturnFromCustomerDetail { get; set; }
        public DbSet<GoodsReturnToSupplier> GoodsReturnToSupplier { get; set; } //ส่งคืนพนักงาน
