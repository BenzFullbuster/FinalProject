...
namespace FinalProject.Models.ViewModels
{
    public class EmployeeViewModel
    {
        ...
        public ICollection<EmployeeWarehouseViewModel> EmployeeWarehouse { get; set; } = [];
    }
    ...
    public class EmployeeCreateViewModel
    {
        ...
        [Required(ErrorMessage = "กรุณากรอกรหัสผู้ใช้งาน")]
        //[RegularExpression(@"^(?=.*[A-Z])[\w\d^\s]{8,}$", ErrorMessage = "ต้องขึ้นต้นด้วยตัวอักษรตัวใหญ่ ทั้งนี้ต้องมีความยาวอย่างน้อย 8 ตัวอักษร")]
    ...
    public class EmployeeWarehouseViewModel
    {
        public Guid EmployeeId { get; set; }
